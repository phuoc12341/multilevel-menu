...
class Menu extends Node {
  ...
  protected $fillable = [
    ...
    public function getUrlAttribute()
    {
        ...
        if ($this->menuable_type == Post::class) {
            $url = route('posts.show', ['id' => $this->menuable->slug]);
        }
        if ($this->menuable_type == Page::class) {
            $url = route('pages.show', ['id' => $this->menuable->slug]);
        }
